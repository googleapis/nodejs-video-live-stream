...
describe('v1.LivestreamServiceClient', () => {
    ...
    describe('getChannel', () => {
        it('invokes getChannel without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetChannelRequest', ['name']);
    ...
    describe('getInput', () => {
        it('invokes getInput without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetInputRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('createEvent', () => {
        it('invokes createEvent without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('CreateEventRequest', ['parent']);
    ...
    describe('getEvent', () => {
        it('invokes getEvent without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetEventRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.video.livestream.v1.Event()
    ...
    describe('deleteEvent', () => {
        it('invokes deleteEvent without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('DeleteEventRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('createChannel', () => {
        it('invokes createChannel without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('CreateChannelRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('deleteChannel', () => {
        it('invokes deleteChannel without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('DeleteChannelRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('updateChannel', () => {
        it('invokes updateChannel without error', async () => {
            ...
            request.channel ??= {};
            const defaultValue1 =
              getTypeDefaultValue('UpdateChannelRequest', ['channel', 'name']);
    ...
    describe('startChannel', () => {
        it('invokes startChannel without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('StartChannelRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('stopChannel', () => {
        it('invokes stopChannel without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('StopChannelRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('createInput', () => {
        it('invokes createInput without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('CreateInputRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('deleteInput', () => {
        it('invokes deleteInput without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('DeleteInputRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('updateInput', () => {
        it('invokes updateInput without error', async () => {
            ...
            request.input ??= {};
            const defaultValue1 =
              getTypeDefaultValue('UpdateInputRequest', ['input', 'name']);
    ...
    describe('listChannels', () => {
        it('invokes listChannels without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListChannelsRequest', ['parent']);
            request.parent = defaultValue1;
    ...
    describe('listInputs', () => {
        it('invokes listInputs without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListInputsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
    ...
    describe('listEvents', () => {
        it('invokes listEvents without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListEventsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
